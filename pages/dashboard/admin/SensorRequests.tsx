...
<div className='flex items-center gap-2'>
 <div className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-500/20 dark:text-blue-100  font-bold text-base">
                    ...
                    <div className="flex-col my-2  items-center gap-5">
                      <h3 className="text-base text-gray-700 dark:text-gray-300">Email: {req.customerId.email}</h3>
                      <h3 className="text-base text-gray-700 dark:text-gray-300">Phone: {req.customerId.phone}</h3>
                    </div>
